function addUser() {
   ...
   if (password == password2 && location1 == "Georgia") {
       ...
       console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_geo.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_ala.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_cali.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_alaska.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_ari.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_ark.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_colo.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_con.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_del.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_flo.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_haw.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_ida.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_ill.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_ind.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_iowa.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_kan.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_ken.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_lou.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_maine.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_mary.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_min.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_misso.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_mis.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_mon.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_neb.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_nev.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_newhamp.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_newjer.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_newmex.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_newyork.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_norcal.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_nordak.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_ohio.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_okla.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_ore.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_penn.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_rhodeisland.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_socal.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_sodak.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_tenn.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_tex.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_utah.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_ver.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_vir.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_wash.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_west.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_wis.html";
   ...
   console.log("In IF");
        ...
        localStorage.setItem("user_name", user_name);
         ...
         window.location = "travel_room_wy.html";
